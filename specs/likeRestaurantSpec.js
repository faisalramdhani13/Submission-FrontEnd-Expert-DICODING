...
describe('Liking a Restaurant', () => {
  ...
  it('should show the like button when restaurant has not been like before', async () => {
  ...
  it('should show the unlike button when movie has not been liked before', async () => {
    await TestFactories.createLikeButtonPresenterWithRestaurant({ id: 1 });
